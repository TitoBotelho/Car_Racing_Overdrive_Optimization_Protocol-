...
// INHERITANCE - Scarlett inherits from the abstract Car class
public class Scarlett : Car
{
    [Header("Scarlett Specific Settings")]
    ...
    // POLYMORPHISM - Override abstract methods with Scarlett-specific implementation
