...
// INHERITANCE - Janice inherits from the abstract Car class
public class Janice : Car
{
    [Header("Janice Specific Settings")]
    ...
    // POLYMORPHISM - Override abstract methods with Janice-specific implementation
